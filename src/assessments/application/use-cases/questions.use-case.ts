...
export class QuestionUseCase {
    private readonly logger = new Logger(QuestionUseCase.name);
    ...
    async saveQuestion(body: QuestionBody) {
        return logOperation(this.logger, 'saveQuestion', {}, async (log) => {
            ...
            log.testCases = savedTestCases.length;
    ...
    async findAllQuestions() {
        return logOperation(this.logger, 'findAllQuestions', {}, async (log) => {
    ...
    async findQuestionById(id: string) {
        return logOperation(this.logger, 'findQuestionById', { questionId: id }, async (log) => {
            ...
            log.testCases = visibleTestCases.length;
            log.hidden = testCases.length - visibleTestCases.length;
